<%--
    ...
    Created on : Nov 1, 2010, 2:43:15 PM
    Author     : A.Ranjan
--%>
...
<div id="container" style="width: 919px">
	...
	<!-- End Navigation -->
	<!-- Begin Content -->
        <%String linkGR="/html-jsp/pmCreateRequest.jsp?id="+id;%>
	<%String linkVMR="/html-jsp/pmViewRequest.jsp?id="+id;%>
        <%String linkM="/html-jsp/mail.jsp?id="+id;%>
        <%String linkCP="/html-jsp/pmCurrentProject.jsp";%>
		...
		<h3 style="width: 908px; " class="style1" align="center"><font color="blue"><%=name%></font></h3>
                 <table>
<!--                    <td style="width: 79px"><html:link page="/html-jsp/project_manager_inside.jsp" target="project_manager">Inbox</html:link></td>-->
                     <td style="width: 122px"><html:link page="<%=linkCP%>" target="project_manager">Current Projects</html:link></td>
                    <td style="width: 122px"><html:link page="<%=linkGR%>" target="project_manager">Request Generation</html:link></td>
                    <td style="width: 122px"><html:link page="<%=linkVMR%>" target="project_manager">View My Requests</html:link></td>
                    <td style="width: 122px"><html:link page="<%=linkM%>" target="project_manager">Mail</html:link></td><br/>
                  </table>
                <iframe src="./html-jsp/project_manager_inside.jsp" name="project_manager" frameborder="0" class="style1" style="width: 898px; height: 445px"></iframe>

...
<%String id=request.getParameter("id");
    ...
    ResultSet rs=pdb.getProjectDetailInfo(id1);
%>
...
Technology:<font size="3"><%=rs.getString("technology")%></font><br/>
End Date:<font size="3"><%=rst.getDate("end_date")%></font><br/>
<%String link="/html-jsp/pmRequirement.jsp?p_id="+rs.getString("p_id")+"&pm_id="+rs.getString("pm_id");%>
<html:link page="<%=link%>"><font size="3" color="blue">Create Request</font></html:link><br/><br/>
<%}%>
<%}%>
</body>

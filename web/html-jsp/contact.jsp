...
<div id="container" style="width: 919px">
	...
	<div id="content" style="width: 910px">
		...
		<h2>Contact</h2>
		<p>Radha,Amit,Apurva,Shruti<br />
		Addresss:-<br />
		Noida<br/>0987654321</p>
                <html:link href="mailto:amitpinku8309@live.com">amitpinku8309@live.com</html:link>
                <p><html:link href="mailto:radha12345@live.com">radha12345@live.com</html:link></p>
		<p><html:link href="mailto:apurvalpu123@live.com">apurvalpu123@live.com</html:link></p>
		<p><html:link href="mailto:shruti54321@live.com">shruti54321@live.com</html:link></p>
		<p>&nbsp;</p>
	...
	<div id="footer" style="width: 916px">
            <p><html:link page="/html-jsp/default.jsp">Home</html:link> | <html:link page="/html-jsp/about.jsp">About</html:link> |
                <html:link page="/html-jsp/news.htm">News</html:link> | <html:link page="/html-jsp/portfolio.jsp">Portfolio</html:link>

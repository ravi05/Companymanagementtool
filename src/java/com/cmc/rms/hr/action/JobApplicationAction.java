...
import com.cmc.rms.hr.formbean.JobApplicationFormBean;
...
public class JobApplicationAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        logic=jadto.candidateApply(name, eMail, cuurentLocation,curLoc, mobile,exp ,skill, qualification, attachResume, resumeHeadline, jobID,sex);

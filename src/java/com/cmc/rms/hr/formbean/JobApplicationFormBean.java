...
public class JobApplicationFormBean extends org.apache.struts.action.ActionForm {
   ...
   public String getJobApplication_checkboxSmsJobAlert() {
        return jobApplication_checkboxSmsJobAlert;
    }


    public void setJobApplication_checkboxSmsJobAlert(String jobApplication_checkboxSmsJobAlert) {
        this.jobApplication_checkboxSmsJobAlert = jobApplication_checkboxSmsJobAlert;
    }
    ...
    public String getJobApplication_selectCountry() {
        return jobApplication_selectCountry;
    }

    public void setJobApplication_selectCountry(String jobApplication_selectCountry) {
        this.jobApplication_selectCountry = jobApplication_selectCountry;
    }

   

    public String getJobApplication_selectExpMonth() {
        return jobApplication_selectExpMonth;
    }

    public void setJobApplication_selectExpMonth(String jobApplication_selectExpMonth) {
        this.jobApplication_selectExpMonth = jobApplication_selectExpMonth;
    }
